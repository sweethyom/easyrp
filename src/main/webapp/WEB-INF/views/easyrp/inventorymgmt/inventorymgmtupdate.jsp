							...
							<div class="card-body mb-3">
								<form action="inventorymgmtupdatefn" method="post">
										...
										<table class="table table-bordered">
											<tr>
												...
												<td><input type="text" id="cod" name="cod"
													class="form-control" value="${getInventoryData.cod }"
											...
											<tr>
												...
												<td><input type="text" id="name" name="name"
													...
													value="${getInventoryData.name }" maxlength="100" required />
												</td>
											</tr>
											<tr>
												<td width="150">첫 입고일</td>
												<td><input type="date" id="invDate" name="invDate"
													value="${getInventoryData.invDate }" class="form-control"
													required /></td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td><input type="number" id="qty" name="qty"
													value="${getInventoryData.qty }" class="form-control"
													placeholder="현재 입고된 재고수량을 입력해주세요." required /></td>
											</tr>
											<tr>
												<td width="150">기초재고 금액(원)</td>
												<td><input type="number" id="price" name="price"
													class="form-control" value="${getInventoryData.price }"
											...
											<tr>
												...
												<td><input type="text" id="spec" name="spec"
													...
													value="${getInventoryData.spec }" maxlength="100" /></td>
											</tr>
											<tr>
												...
												<td><input type="number" id="safetyInvQty"
													...
													value="${getInventoryData.safetyInvQty }" required /></td>
											</tr>
											<tr>
												...
												<td><input type="text" id="productGroupName"
													...
													value="${getInventoryData.productGroupName }" disabled
											...
											<tr>
												...
												<td><input type="text" id="unitName"
													...
													value="${getInventoryData.unitName }" disabled required />
											...
											<tr>
												...
												<td><input type="number" id="unitAmount"
													...
													value="${getInventoryData.unitAmount}"
											...
											<tr>
												...
												<td><input type="text" id="mgmtUnitName"
													...
													value="${getInventoryData.mgmtUnitName }" disabled required />
											...
											<tr>
												...
												<td><input type="number" id="mgmtUnitAmount"
													...
													value="${getInventoryData.mgmtUnitAmount}"
											...
											<tr>
												...
												<td><input type="text" id="warehouseName"
													...
													value="${getInventoryData.warehouseName }" disabled
											...
											<tr>
												...
												<td><input type="text" id="note" name="note"
													...
													value="${getInventoryData.note }" /></td>
											</tr>
										</table>
									</div>
									...
									<input type="hidden" id="curInvQty" name="curInvQty"
										value="${getInventoryData.curInvQty }" readonly required /> <input
										type="hidden" id="curInvPrice" name="curInvPrice"
										value="${getInventoryData.curInvPrice }" readonly required />
								</form>
							</div>
						</div>
					</div>
